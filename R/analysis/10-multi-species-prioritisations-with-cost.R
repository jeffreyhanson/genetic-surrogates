## load .rda
session::restore.session('results/.cache/09-format-data-for-prioritisations.rda')
...
## save .rda
save.session('results/.cache/10-multi-species-prioritisations-with-cost.rda', compress='xz')
