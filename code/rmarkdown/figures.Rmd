...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=calc.fig.height2(n_distinct(geo.surrogacy.DF$Species)), fig.cap='The relationship between the proportion of neutral genetic variation secured in a prioritizaiton and the proportion of geographic variation it also secures. Conventions are detailed in Figure SXXX.'}
# format data
