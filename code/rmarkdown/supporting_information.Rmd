...
if (1 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[1] %in% missing.species)) plot.spp.nmds(1)
 ```
...
if (2 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[2] %in% missing.species)) plot.spp.nmds(2)
```
...
if (3 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[3] %in% missing.species)) plot.spp.nmds(3)
```
...
if (4 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[4] %in% missing.species)) plot.spp.nmds(4)
```
...
if (5 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[5] %in% missing.species)) plot.spp.nmds(5)
```
...
if (6 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[6] %in% missing.species)) plot.spp.nmds(6)
```
...
if (7 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[7] %in% missing.species)) plot.spp.nmds(7)
```
...
if (8 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[8] %in% missing.species)) plot.spp.nmds(8)
```
...
if (9 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[9] %in% missing.species)) plot.spp.nmds(9)
```
...
if (10 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[10] %in% missing.species)) plot.spp.nmds(10)
```
...
if (11 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[11] %in% missing.species)) plot.spp.nmds(11)
```
...
if (12 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[12] %in% missing.species)) plot.spp.nmds(12)
```
...
if (13 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[13] %in% missing.species)) plot.spp.nmds(13)
```
...
if (14 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[14] %in% missing.species)) plot.spp.nmds(14)
```
...
if (15 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[15] %in% missing.species)) plot.spp.nmds(15)
```
...
if (16 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[16] %in% missing.species)) plot.spp.nmds(16)
```
...
if (17 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[17] %in% missing.species)) plot.spp.nmds(17)
```
...
if (18 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[18] %in% missing.species)) plot.spp.nmds(18)
```
...
if (19 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[19] %in% missing.species)) plot.spp.nmds(19)
```
...
if (20 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[20] %in% missing.species)) plot.spp.nmds(20)
```
...
if (21 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[21] %in% missing.species)) plot.spp.nmds(21)
```
...
if (22 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[22] %in% missing.species)) plot.spp.nmds(22)
```
...
if (23 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[23] %in% missing.species)) plot.spp.nmds(23)
```
...
if (24 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[24] %in% missing.species)) plot.spp.nmds(24)
```
...
if (25 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[25] %in% missing.species)) plot.spp.nmds(25)
```
...
if (26 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[26] %in% missing.species)) plot.spp.nmds(26)
```
...
if (27 <= general.params.LST[[MODE]]$n.spp & (!unique(spp.samples.DF$species)[27] %in% missing.species)) plot.spp.nmds(27)
```
...
```{r, echo=FALSE}
write.table(loci_classification.DF, 'article/Table_S2.csv', sep=',', row.names=FALSE)
```
