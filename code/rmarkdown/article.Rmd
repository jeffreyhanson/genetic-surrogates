...
<!-- scenario analysis -->
To determine if the addition of environmental and geographic targets could actually improve the effectiveness of prioritisations, we generated prioritisations according to three scenarios using different targets (Figure S58). We then computed the proportion of adaptive and neutral genetic variation secured in each prioritisation (Figure 3). We found no evidence to suggest that any interaction terms were significant (${\chi^2}_{`r scenario.ANOVA.1.DF$Chi.Df[[2]]`} = `r round(scenario.ANOVA.1.DF$statistic[[2]],2)`$; $P `r pvalString(scenario.ANOVA.1.DF$p.value[[2]])`$). This result indicates the trends observed in each of the main effects were consistent across all other levels in the main effects.
