#' Make AttributeSpaces object using general data
#'
#' This function generates an \code{AttributeSpaces} object using values in a \code{data.frame} and occupancy data in a second \code{data.frame}.
...
#' @export
make.general.AttributeSpaces <- function(site.data, species.data, name) {
	return(
		AttributeSpaces(
			spaces=llply(
