...
# random effects
env.correlation.RPDF <- expand.grid(
	Surrogate.type='Environmental variation',
	Surrogate.target=seq(min(env.correlation.DF$Surrogate.target), max(env.correlation.DF$Surrogate.target), length.out=100),
	Species=unique(env.correlation.DF$Species)
)
env.correlation.RPDF$a.ranef <- fixef(env.correlation.NLMM)[[1]] + ranef(env.correlation.NLMM)$Species$a[env.correlation.RPDF$Species]
env.correlation.RPDF$r.ranef <- fixef(env.correlation.NLMM)[[2]] + ranef(env.correlation.NLMM)$Species$r[env.correlation.RPDF$Species]
env.correlation.RPDF$fit <- env.correlation.RPDF$a.ranef - (env.correlation.RPDF$a.ranef - 0) * exp(- env.correlation.RPDF$r.ranef * env.correlation.RPDF$Surrogate.target)
# fixed effects
...
env.correlation.FPDF$fit <- fixef(env.correlation.NLMM)[[1]] - (fixef(env.correlation.NLMM)[[1]] - 0) * exp(- fixef(env.correlation.NLMM)[[2]] * env.correlation.FPDF$Surrogate.target)
## geographic vs neutral
# random effects
geo.correlation.RPDF <- expand.grid(
	Surrogate.type='Geographic variation',
	Surrogate.target=seq(min(geo.correlation.DF$Surrogate.target), max(geo.correlation.DF$Surrogate.target), length.out=100),
	Species=unique(geo.correlation.DF$Species)
)
geo.correlation.RPDF$a.ranef <- fixef(geo.correlation.NLMM)[[1]] + ranef(geo.correlation.NLMM)$Species$a[geo.correlation.RPDF$Species]
geo.correlation.RPDF$r.ranef <- fixef(geo.correlation.NLMM)[[2]] + ranef(geo.correlation.NLMM)$Species$r[geo.correlation.RPDF$Species]
geo.correlation.RPDF$fit <- geo.correlation.RPDF$a.ranef - (geo.correlation.RPDF$a.ranef - 0) * exp(- geo.correlation.RPDF$r.ranef * geo.correlation.RPDF$Surrogate.target)
# fixed effects
...
geo.correlation.FPDF$fit <- fixef(geo.correlation.NLMM)[[1]] - (fixef(geo.correlation.NLMM)[[1]] - 0) * exp(- fixef(geo.correlation.NLMM)[[2]] * geo.correlation.FPDF$Surrogate.target)
