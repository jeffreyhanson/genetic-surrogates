...
```{r, echo=FALSE, fig.width=4, fig.height=2.5, fig.cap="Species richness. Squares denote planning units. Planning units with a darker color are inhabited by more species."}
...
suppressWarnings({
	ggplot(data=bic.DF) +
		...
		theme(
			strip.background = element_rect(fill='grey20'),
			strip.text = element_text(color='white', face='italic', size=3)
		) +
...
valid.species <- function(i) {
	return((i <= n_distinct(spp.samples.DF$species)) & (!unique(spp.samples.DF$species)[i] %in% missing.species))
}
```
...
if (valid.species(1)) plot.spp.nmds(1)
 ```
...
if (valid.species(3)) plot.spp.nmds(2)
```
...
if (valid.species(3)) plot.spp.nmds(3)
```
...
if (valid.species(4)) plot.spp.nmds(4)
```
...
if (valid.species(5)) plot.spp.nmds(5)
```
...
if (valid.species(6)) plot.spp.nmds(6)
```
...
if (valid.species(7)) plot.spp.nmds(7)
```
...
if (valid.species(8)) plot.spp.nmds(8)
```
...
if (valid.species(9)) plot.spp.nmds(9)
```
...
if (valid.species(10)) plot.spp.nmds(10)
```
...
if (valid.species(11)) plot.spp.nmds(11)
```
...
if (valid.species(12)) plot.spp.nmds(12)
```
...
if (valid.species(13)) plot.spp.nmds(13)
```
...
if (valid.species(14)) plot.spp.nmds(14)
```
...
if (valid.species(15)) plot.spp.nmds(15)
```
...
if (valid.species(16)) plot.spp.nmds(16)
```
...
if (valid.species(17)) plot.spp.nmds(17)
```
...
if (valid.species(18)) plot.spp.nmds(18)
```
...
if (valid.species(19)) plot.spp.nmds(19)
```
...
if (valid.species(20)) plot.spp.nmds(20)
```
...
if (valid.species(21)) plot.spp.nmds(21)
```
...
if (valid.species(22)) plot.spp.nmds(22)
```
...
if (valid.species(23)) plot.spp.nmds(23)
```
...
if (valid.species(24)) plot.spp.nmds(24)
```
...
if (valid.species(25)) plot.spp.nmds(25)
```
...
if (valid.species(26)) plot.spp.nmds(26)
```
...
if (valid.species(27)) plot.spp.nmds(27)
```
