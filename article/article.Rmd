...
We investigated the relationship between surrogate-based targets and the genetic variation secured in a prioritization using nonlinear mixed-effects models (NLMMs; using the $\texttt{lme4}$ R package). Two models were fit to the adaptive and neutral genetic variation secured using a negative exponential formulation to estimate the rate of the accumulation of genetic variation ($y = 0 + (0 - 1) \times exp(-r \times x)$; $r$ is the accumulate rate). Both models accomodated random effects for the accumulation rate ($r$) parameter.
